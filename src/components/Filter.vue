  ...
  <div class="filter layout-container">
    ...
    <div class="projects">
      ...
      <router-link
          ...
          class="link"
      >
        <ProjectCard :imgPath="projects.EHCT.imgPath" :tag="tags.web" :title="projects.EHCT.title" :caption="projects.EHCT.caption"/>
      </router-link>
      <router-link
          v-if="tags.web === true"
          :to="{
          ...
          class="link"
      >
        <ProjectCard :imgPath="projects.Orbit.imgPath" :tag="tags.web" :title="projects.Orbit.title" :caption="projects.Orbit.caption"/>
      </router-link>
      <router-link
          v-if="tags.web === true"
          :to="{
          ...
          class="link"
      >
        <ProjectCard :imgPath="projects.IPA.imgPath" :tag="tags.web" :title="projects.IPA.title" :caption="projects.IPA.caption"/>
      </router-link>
      <router-link
          v-if="tags.web === true"
          :to="{
      ...
      <router-link
          ...
          class="link"
      >
        <ProjectCard :imgPath="projects.Spaetsommerfest.imgPath" :tag="tags.print" :title="projects.Spaetsommerfest.title" :caption="projects.Spaetsommerfest.caption"/>
      </router-link>
      <router-link
          v-if="tags.print === true"
          :to="{
          ...
          class="link"
      >
        <ProjectCard :imgPath="projects.Street_Physics.imgPath" :tag="tags.print" :title="projects.Street_Physics.title" :caption="projects.Street_Physics.caption"/>
      </router-link>
      <router-link
          v-if="tags.video === true"
          :to="{
